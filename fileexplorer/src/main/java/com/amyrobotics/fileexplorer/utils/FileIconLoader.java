...
public class FileIconLoader implements Callback {
    private static final String TAG = FileIconLoader.class.getSimpleName();
        ...
        if (holder == null) {
            ...
            switch (cate) {
                case Picture: {
                    ...
                    loadImage(mContext, 0, path, view);
                    return true;
                }
            }
            //add 2018-05-14
    ...
    public static void loadImage(Context mContext, int holder, String imgUrl, ImageView imageView) {
        //R.drawable.file_image_v2
        if (imgUrl.toUpperCase().endsWith(".GIF")) {
            RequestOptions gifOptions = new RequestOptions()
//                .placeholder(holder)
//                .error(R.drawable.error)
                    .dontAnimate() //gif 不显示动画
