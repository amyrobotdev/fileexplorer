...
import com.amyrobotics.fileexplorer.views.CategoryBar;
import com.amyrobotics.fileexplorer.viewmodel.FavoriteDatabaseHelper.FavoriteDatabaseListener;
import com.amyrobotics.fileexplorer.viewmodel.FavoriteList;
import com.amyrobotics.fileexplorer.utils.FileCategoryHelper;
import com.amyrobotics.fileexplorer.utils.FileCategoryHelper.CategoryInfo;
import com.amyrobotics.fileexplorer.utils.FileCategoryHelper.FileCategory;

import com.amyrobotics.fileexplorer.utils.FileIconHelper;
import com.amyrobotics.fileexplorer.viewmodel.FileInfo;
import com.amyrobotics.fileexplorer.viewmodel.FileListCursorAdapter;
import com.amyrobotics.fileexplorer.viewmodel.FileSortHelper;
import com.amyrobotics.fileexplorer.viewmodel.FileViewInteractionHub;
import com.amyrobotics.fileexplorer.viewmodel.FileViewInteractionHub.Mode;
import com.amyrobotics.fileexplorer.config.GlobalConsts;
import com.amyrobotics.fileexplorer.viewmodel.IFileInteractionListener;
import com.amyrobotics.fileexplorer.utils.Util;
import com.amyrobotics.fileexplorer.utils.Util.SDCardInfo;
...
public class FileCategoryActivity extends BaseFragment implements IFileInteractionListener,
        FavoriteDatabaseListener, FileExplorerTabActivity.IBackPressedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ListView fileListView = mRootView.findViewById(R.id.file_path_list);
    ...
    private void setupCategoryInfo() {
        ...
        mCategoryBar = mRootView.findViewById(R.id.category_bar);
        int[] imgs = new int[] {
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            //add 2018-05-15 添加 SD卡，U盘跳转
            switch (v.getId()) {
                case R.id.category_sdcard:
                    ((FileExplorerTabActivity)mActivity).jumpLocationFileView(Util.getSdDirectory());
                    return;
                case R.id.category_usb:
                    ((FileExplorerTabActivity)mActivity).jumpLocationFileView(Util.getUpanDir());
                    return;
            }
            //add 2018-05-15
    ...
    private void setTextView(int id, String t) {
        TextView text = mRootView.findViewById(id);
        text.setText(t);
    }
    ...
    private void setupClick() {
        ...
        //[]
        setupClick(R.id.category_usb);
        setupClick(R.id.category_sdcard);
