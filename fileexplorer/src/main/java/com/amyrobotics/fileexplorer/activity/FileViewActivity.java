...
import com.amyrobotics.fileexplorer.utils.ActivitiesManager;

import com.amyrobotics.fileexplorer.activity.FileExplorerTabActivity.IBackPressedListener;
...
import com.amyrobotics.fileexplorer.viewmodel.FileListAdapter;
...
import com.amyrobotics.fileexplorer.config.Settings;
import com.amyrobotics.fileexplorer.utils.Util;

public class FileViewActivity extends BaseFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mFileListView = mRootView.findViewById(R.id.file_path_list);
    ...
    public boolean onRefreshFileList(String path, FileSortHelper sort) {
        ...
        mFileListView.post(new Runnable() {
            ...
            public void run() {
                int selectPos = pos;
                if(selectPos >= 0 && selectPos < mFileNameList.size()) {
                    mFileListView.setSelection(selectPos);
                }
    ...
    public String getDisplayPath(String path) {
        if (path.startsWith(sdDir) && !FileExplorerPreferenceActivity.showRealPath(mActivity)) {
            return getString(R.string.sd_folder) + path.substring(sdDir.length());
        } else {
            return path;
        }
    }
